...
[imagem do método matches no código]
...
- Database: o método connect() cria um objeto do tipo Connection, classe da biblioteca JDBC, ..., aproveitamos para colocar o método criarTabela() dentro deste método, para que a existência da tabela seja verificada a cada conexão, e que rla seja criada caso não exista. O método inserirPalestrantes(), o palestrante que é passado via parâmetro pode ser obtido com o método readTxt().  listarPalestrantes()
